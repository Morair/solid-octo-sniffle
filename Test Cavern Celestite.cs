...
public class BluuPurpleTemplate
{
	...
	public readonly int[] SkillOrder = { 3, 4, 2, 1, 2, 1 };
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
			...
			FormatLog(Title: true, Text: "Cavern Celestite");
			ItemFarm("Bone Terror Soul", 1, 
					Temporary: true, 
					QuestID: 939, 
					MonsterName: "Bone Terror", 
					MapName: "battleundera", 
					CellName: "r7", 
					PadName: "Left");
			ItemFarm("Undead Champion Soul", 1, 
					Temporary: true, 
					QuestID: 939, 
					MonsterName: "Undead Champion", 
					MapName: "battleunderb", 
					CellName: "r3", 
					PadName: "Right");
			ItemFarm("Jellyfish Soul", 1, 
					Temporary: true, 
					QuestID: 939, 
					MonsterName: "Crystalized Jellyfish", 
					MapName: "battleunderc", 
					CellName: "r5", 
					PadName: "Left");
	...
	*/
	...
	/// </summary>
	public void ConfigureBotOptions(string PlayerName = "F I V E", string GuildName = "", bool LagKiller = true, bool SafeTimings = true, bool RestPackets = true, bool AutoRelogin = true, bool PrivateRooms = false, bool InfiniteRange = true, bool SkipCutscenes = true, bool ExitCombatBeforeQuest = true, bool HideMonster=true)
	{
